...
*   **Tampilan Sebelum Terhubung (Belum Aktif):** 
    Pada tahap awal, sistem akan meminta otentikasi. Anda perlu mengklik tombol hijau **Connect Google Account** untuk memberikan izin akses pembuatan sheet output tiket.
