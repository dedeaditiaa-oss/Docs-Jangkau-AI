...
Setelah Anda selesai mengisi komponen Nama Prioritas dan Kondisi Prioritas di atas, jangan lupa untuk selalu mengklik tombol hijau **Simpan** pada kotak *Simpan Perubahan* di sebelah kanan layar agar AI segera menerapkan aturan kecerdasan penentuan urgensi ini pada sistem tiket Anda.